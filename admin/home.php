				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle">Period: May 31, 2022 - Jun 10, 2022</p>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="weekly-summary text-right">
										<span class="number">1,315</span> <span class="percentage"><i class="fa fa-caret-up text-success"></i> 12%</span>
										<span class="info-label">Total Sales</span>
									</div>
									<div class="weekly-summary text-right">
										<span class="number">$4,542</span> <span class="percentage"><i class="fa fa-caret-up text-success"></i> 23%</span>
										<span class="info-label">Monthly Income</span>
									</div>
									<div class="weekly-summary text-right">
										<span class="number">$75,938</span> <span class="percentage"><i class="fa fa-caret-down text-danger"></i> 8%</span>
									...
									<ul class="list-unstyled todo-list">
										...
										<li>
											...
											<p>
												...
												<span class="short-description">Implement clicks-and-mortar relationships without highly efficient metrics.</span>
												<span class="date">June 10, 2022</span>
											</p>
											<div class="controls">
												<a href="#"><i class="icon-software icon-software-pencil"></i></a> <a href="#"><i class="icon-arrows icon-arrows-circle-remove"></i></a>
										...
										<li>
											...
											<p>
												...
												<span class="short-description">Formulate client-focused core competencies after parallel web-readiness.</span>
												<span class="date">June 10, 2022</span>
											</p>
											<div class="controls">
												<a href="#"><i class="icon-software icon-software-pencil"></i></a> <a href="#"><i class="icon-arrows icon-arrows-circle-remove"></i></a>
